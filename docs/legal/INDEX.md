...
|---|---|---|---|---|---|
| `revise_tokushoho-stripe_20260610/` | revise | tokushoho-stripe | 実装完了（unit 8件 GREEN、2026-06-10） | 特商法ページ `/legal/commerce` 追加 + 業態整合（寄付PF→マイクロサービス運営）+ Footer "powered by givers.work" | [INDEX](./revise_tokushoho-stripe_20260610/INDEX.md) |
