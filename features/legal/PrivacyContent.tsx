  ...
  return (
    <div className="flex flex-col gap-6 leading-relaxed text-ink">
      <p className="text-ink-muted">
        本サイト（givers.work）における個人情報の取り扱いについて、以下のとおり定めます。
      </p>
      ...
      <section>
        ...
        <p className="mt-1 text-ink-muted">
          ...
          <strong>お問い合わせ本文</strong>{" "}
          のみを取得します。これら以外の個人情報（氏名・住所・電話番号など）は取得しません。
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-1 text-ink-muted">
          ...
          外部の AI
          サービスへ送信することはありません。メール通知のための送信を除き、入力内容を
          外部サービスへ共有しません。
        </p>
      </section>
      ...
      <section>
        <h2 className="text-lg font-semibold">
          アクセス解析（Cookie を使いません）
        </h2>
        <p className="mt-1 text-ink-muted">
          本サイトは Cookie
          による追跡や広告を行いません。アクセス解析を行う場合も、Cookie
          を使わない 方式（cookieless）で、個人を特定しません。
        </p>
      </section>
